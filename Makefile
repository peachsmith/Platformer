SRC=src/main.cpp src/Entity.cpp src/Terrain.cpp src/Player.cpp src/HitBox.cpp src/Scenery.cpp src/Menu.cpp src/MenuItem.cpp src/MenuCursor.cpp src/pxp.cpp src/Level1.cpp src/Level2.cpp
